...
stop_time_data = pd.read_csv("../data/google_transit_M89/20250328_google_transit_M89_010/stop_times.txt")
...
def stop_time_populate(data):
    for index, row in data.iterrows():
        newStopTime = namespace.StopTime("StopTimeM89_10_" + str(index + 1))
